...
API_HASH = environ.get('API_HASH', '4c6e3cdf48246d090e0249e76a1199e1')
BOT_TOKEN = environ.get('BOT_TOKEN', '6949240822:AAF9VU59akVRmG3D51aCnLjK4dQoQ-FTA4o')

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = is_enabled((environ.get('USE_CAPTION_FILTER', 'True')), True)

PICS = (environ.get('PICS', 'https://telegra.ph/file/cf24c19270897a8bebbaf.jpg')).split()
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5431249569 5896993964').split()]
